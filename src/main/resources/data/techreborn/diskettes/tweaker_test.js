...
var TRTweaker = diskette.require("techreborn.TRTweaker");
...
TRTweaker.addCentrifuge(["minecraft:potion"], [DriverUtils.makeSpecialStack("minecraft:potion->minecraft:water")], 5, 1000);

//Add a chemical reactor recipe that takes a water bottle and a can of methane -> a potion of fire resistance
//DISCLAIMER: do not try this at home
TRTweaker.addChemicalReactor(["minecraft:potion->minecraft:water", TRTweaker.createFluidIngredient("techreborn:methane", ["techreborn:cell"], -1)], [DriverUtils.makeSpecialStack("minecraft:potion->minecraft:fire_resistance")], 30, 800);
...
TRTweaker.addDistillationTower(["minecraft:potion->minecraft:regeneration"], [DriverUtils.makeSpecialStack("minecraft:potion->minecraft:strong_regeneration")], 20, 400);
...
TRTweaker.addSolidCanningMachine(["techreborn:cell{}", "minecraft:blue_ice"], [DriverUtils.makeSpecialStack("techreborn:cell->minecraft:water")], 1, 100);
