...
- **Advanced Machine Casing** used to build multi-block machines like the <Mcitem id="techreborn:industrial_grinder"/>.
...
`<recipe>` input techreborn:steel_plate techreborn:steel_plate
...
output techreborn:advanced_machine_casing,4 `</recipe>` \\\\
`<recipe>` input techreborn:steel_plate techreborn:steel_plate
techreborn:steel_plate input techreborn:advanced_circuit
techreborn:basic_machine_casing techreborn:advanced_circuit input
techreborn:steel_plate techreborn:steel_plate techreborn:steel_plate
output techreborn:advanced_machine_casing `</recipe>`
...
techreborn:fusion_coil `</recipe>` \\\\ `<recipe>` input
