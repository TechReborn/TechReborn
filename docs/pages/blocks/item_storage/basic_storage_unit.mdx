...
`<recipe>` input techreborn:refined_iron_plate
...
techreborn:basic_storage_unit `</recipe>`

##### Usage

Besides storing 8192 items **Basic Storage Unit** used in crafting
recipes. `<recipe>` input techreborn:electrum_plate
...
techreborn:advanced_storage_unit `</recipe>` \\\\

`<recipe>` input air techreborn:cell air input techreborn:rubber
techreborn:basic_storage_unit techreborn:rubber input air
techreborn:cell air output techreborn:basic_tank_unit `</recipe>`
