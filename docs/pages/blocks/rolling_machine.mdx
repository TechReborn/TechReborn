...
`<recipe>` input minecraft:piston techreborn:advanced_circuit
...
minecraft:piston output techreborn:rolling_machine `</recipe>`
\\\\
...
`<recipe>` input techreborn:nickel_ingot techreborn:copper_ingot
...
`<recipe>` input air techreborn:nickel_ingot air input
...
`<recipe>` input techreborn:aluminium_ingot
...
`<recipe>` input minecraft:iron_ingot air minecraft:iron_ingot
...
tool techreborn:rolling_machine `</recipe>` \\\\

`<recipe>` input minecraft:gold_ingot air minecraft:gold_ingot
...
`<recipe>` input minecraft:iron_ingot minecraft:stick
...
`<recipe>` input minecraft:iron_ingot minecraft:iron_ingot
...
`<recipe>` input minecraft:iron_ingot minecraft:iron_ingot air
input minecraft:iron_ingot minecraft:iron_ingot air input
minecraft:iron_ingot minecraft:iron_ingot air output
minecraft:iron_door,4 tool techreborn:rolling_machine `</recipe>`
\\\\
