...
<Recipe recipe=" input techreborn:invar_ingot techreborn:extractor
...
* ``![Calciumcarbonate Cell](/mods/techreborn/calcium_cell.png|Calcium Cell}}
* `[`Calcium Cell`](items:fluid:calcium_cell "wikilink")`** + ``![Carbon Cell](/:mods:techreborn:carbon_cell.png) 
* `[`Carbon Cell`](items:fluid:carbon_cell "wikilink")`** -> 2x ``![](/:mods:techreborn:calciumcarbonate_cell.png)
*`[`Calciumcarbonate Cell`](items:fluid:calciumcarbonate_cell "wikilink")`*
