...
`<recipe>` input air minecraft:stick air input
...
input air output techreborn:extractor `</recipe>` \\\\
`<recipe>` input techreborn:rubber_planks techreborn:treetap
