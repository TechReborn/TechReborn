...
<Recipe recipe=" input air air air input air techreborn:invar_ingot air
input air air air output techreborn:invar_nugget,9 "/>
\\\\

##### Usage

<Recipe recipe=" input techreborn:invar_nugget techreborn:invar_nugget
