...
`<recipe>` input air air air input air minecraft:diamond air
input air air air output techreborn:diamond_nugget,9 `</recipe>`
\\\\

##### Usage

`<recipe>` input techreborn:diamond_nugget
