...
`<recipe>` input air techreborn:refined_iron_ingot
...
techreborn:basic_chainsaw `</recipe>`

##### Usage

Besides main usage as an axe **Basic Chainsaw** could be used in
crafting. `<recipe>` input air minecraft:diamond
...
techreborn:diamond_chainsaw `</recipe>`
