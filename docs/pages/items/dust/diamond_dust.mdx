...
output techreborn:diamond_saw_blade,4 "/>
<Recipe recipe=" input techreborn:diamond_dust techreborn:steel_ingot
...
techreborn:diamond_grinding_head,2 "/>
...
minecraft:glass output techreborn:glass_fiber_cable,8 "/>
\\\\ \\\\
