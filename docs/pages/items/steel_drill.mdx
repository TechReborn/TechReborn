...
<Recipe recipe=" input air techreborn:steel_ingot air input
...
techreborn:steel_ingot output techreborn:steel_drill "/>
\\\\ \\\\

##### Usage

Besides main usage as a mining tool **Steel Drill** could be used in
crafting. <Recipe recipe=" input air minecraft:diamond air input
