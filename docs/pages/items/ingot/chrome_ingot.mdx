...
air output techreborn:chrome_ingot,9 `</recipe>` \\\\ \\\\
...
output techreborn:chrome_storage_block `</recipe>` \\\\
`<recipe>` input air techreborn:chrome_ingot air output
techreborn:chrome_nugget,9 `</recipe>` \\\\
